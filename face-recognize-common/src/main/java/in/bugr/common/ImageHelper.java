...
public class ImageHelper {
    ...
    public static byte[] bgrToByteImage(byte[] data, int width, int height) {
        BufferedImage bufferedImage = bgrToBufferedImage(data, width, height);
